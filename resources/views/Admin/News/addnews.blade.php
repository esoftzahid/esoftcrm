...
@section('title','Add News | Journal Management System')
@section('mainpanel')
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Add News</h4>
            <p class="mg-b-0">Here you can create your News</p>
        </div>
                    ...
                    <div class="form-layout form-layout-1">
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="sub_title" placeholder="Enter Date">
                                </div>
                            </div>
                        </div><!-- row -->
                        <div class="row mg-b-25">
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-3">
                                ...
                                <input class="form-control" type="file" name="image" id="imageInput" placeholder="Image" accept="image/*" required>
