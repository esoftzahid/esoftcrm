...
@section('title','Edit Page | Journal Management System')
@section('mainpanel')
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            ...
            <p class="mg-b-0">Here you can Edit your page</p>
        </div>
        <script src="https://cdn.ckeditor.com/4.16.1/standard/ckeditor.js"></script>

        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Edit Page</h6>
                ...
                <form role="form" method="post" action="{{ route('page.update',$page->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-layout form-layout-1">
                        <div class="row mg-b-25">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title" placeholder="Enter Title" value="{{ $page->title }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <textarea class="form-control ckeditor" rows="3" name="description">{{ $page->description }}</textarea>
                            </div>
                        </div>
