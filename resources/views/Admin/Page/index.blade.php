...
@section('title','All Page | Journal Management System')
@section('script')
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">All Page</span>
            </nav>
        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">All Page</h4>
            <p class="mg-b-0">Here is your all page</p>
        </div>
        <script src="https://cdn.ckeditor.com/4.16.1/standard/ckeditor.js"></script>

        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">All Page</h6>
<div class="form-layout form-layout-1">
    <a style="float:right;color: white;" href="{{ route('addpage') }}" class="btn btn-info tx-11 pd-y-12 tx-uppercase tx-spacing-2">Add Page</a>
    ...
    <table id="employeeTable" class="table table-striped table-bordered" style="width:100%">
                    ...
                    @foreach($page as $key=>$page)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('page.edit',$page->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
