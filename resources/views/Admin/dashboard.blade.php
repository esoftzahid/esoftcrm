...
@section('title','Dashboard | Journal Management System')
...
@section('mainpanel')
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-30">
            ...
            <p class="mg-b-0">Welcome to the Journal Management System, your efficient platform for seamless manuscript submission, peer review, and publication management.</p>
        </div><!-- d-flex -->
            ...
            <div class="row row-sm">
                ...
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
                    <div class="bg-danger rounded overflow-hidden">
                        <div class="pd-25 d-flex align-items-center">
                            <i class="fa fa-suitcase tx-60 lh-0 tx-white op-7"></i>
                            <div class="mg-l-20">
                ...
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
                    <div class="bg-br-primary rounded overflow-hidden">
                        <div class="pd-25 d-flex align-items-center">
                            <i class="fa fa-clock-o tx-60 lh-0 tx-white op-7"></i>
                            <div class="mg-l-20">
